...
To see the references in qdiv, use:
...
*f* is the qdiv function. For example, f='diversity.naive_alpha' prints the references that were especially relevant for developing the diversity.naive_alpha function.
...
Evenness (diversity.evenness, diversity.dissimilarity_by_feature, plot.dissimilarity_contributions):
