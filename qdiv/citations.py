def citations(f="all") -> None:
    """
    Function to show key references that were important for developing qdiv.

    Parameters
    ----------
    f : str, optional
        Define for which function references will be displayed. The default is "all".
    ...
    if f == "all" or f in ["diversity.evenness", "diversity.dissimilarity_by_feature", "plot.dissimilarity_contributions"]:
        print("\nEvenness:")
        print("Chao, A. and C. Ricotta (2019). Ecology 100(12): e02852.")
    if f == "all" or f in ["model.rcq"]:
        print("\nRCq null model:")
